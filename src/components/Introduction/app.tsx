...
*/
    ...
    function loadVRM( modelUrl:any ) { // モデルを読み込む処理
    ...
    const modelUrl = 'https://cdn.glitch.me/c4e5cfb3-513e-4d82-a37f-62836378466b%2Fthree-vrm-girl-1.0-beta.vrm?v=1636610288920';
        ...
        clip.tracks.forEach( ( track ) => {
          ...
          if ( vrmNodeName != null ) {
            ...
            if ( track instanceof THREE.QuaternionKeyframeTrack ) {
              ...
              const value = track.values.map( ( v, i ) => ( vrm.meta?.metaVersion === '0' && i % 3 !== 1 ? - v : v ) * 0.01 );
    
              tracks.push( new THREE.KeyframeTrack( `${nodeName}.${propertyName}`, track.times, value ) );
